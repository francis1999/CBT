...
<div style="margin:auto;width:80%; height:600px;box-shadow:2px 1px 2px 2px #CCCCCC;text-align:left; border-radius: 10px;">
		...
		<div class="head" style="background-color: #00aad0; height: 50px; border-radius: 5px 5px 2px 1px; margin-bottom: 30px;">
		     <a href="testadd.php" style="float: left; color: #ffffff; font-size: 20px; margin-left: 10px; margin-top: 10px;">Back</a>
		...
		<table class="tbl-qa">
		  <thead>
			  <tr>
				...
				<th class="table-header">TOTAL QUESTION</th>
			  </tr>
		  </thead>
		  <tbody>
		  <?php
		  ...
		  ?>
			  <tr class="table-row">
				...
				<td contenteditable="true" onBlur="saveToDatabase(this,'test_name','<?php echo $faq[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $faq[$k]["test_name"]; ?></td>

				<td contenteditable="true" onBlur="saveToDatabase(this,'total_que','<?php echo $faq[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $faq[$k]["total_que"]; ?></td>
			  </tr>
		<?php
		}
		?>
